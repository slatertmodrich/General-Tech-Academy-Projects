	...
	****************************************************/
		...
		VALUES
			(1, 1, 1, '2018-01-01', '2018-02-01'),
			(2, 2, 2, '2018-01-02', '2018-02-02'),
			...
			(11, 3, 1, '2018-01-11', '2018-02-11'),
			(12, 4, 2, '2018-01-12', '2018-02-12'),
			(13, 1, 1, '2018-01-13', '2018-02-13'),
			(14, 2, 2, '2018-01-14', '2018-02-14'),
			(15, 3, 1, '2018-01-15', '2018-02-15'),
			(16, 4, 2, '2018-01-16', '2018-02-16'),
			(17, 1, 1, '2018-01-17', '2018-02-17'),
			(18, 2, 2, '2018-01-18', '2018-02-18'),
	 ...
	 ******************************/
GO
	 CREATE PROC spFirstProc
	 AS
		SELECT Copies
		FROM BookCopies WHERE BookID = 21 AND BranchID = 4 
GO

GO
	CREATE PROC spSecondProc
	AS
		SELECT Copies 
		FROM BookCopies WHERE BookID = 21 AND BranchID >0 AND BranchID <5
GO
...
GO
	...
	AS 
		SELECT BorrowerName 
		FROM Borrower WHERE CardNo = 0
GO 
			
GO
	CREATE PROC spFourthProc
	AS 
		SELECT 
			a1.Title
			FROM Book a1
			INNER JOIN BookLoans a2 ON a2.BookID = a1.BookID 
			INNER JOIN 
			/* This is where I'm having trouble figuring out how to use JOIN,
			I have tried searching online but I am still having some trouble 
			understanding what to do at this point. Is there any chance you 
