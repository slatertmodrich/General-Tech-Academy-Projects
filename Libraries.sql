...
GO
	...
	AS 
		...
		WHERE BookLoans.DueDate < {d '2018-06-15'}
GO 
...
GO 
	...
	AS 
		SELECT LibraryBranch.BranchName, BookCopies.Copies
			FROM BookCopies
			INNER JOIN LibraryBranch ON BookCopies.BookID = LibraryBranch.BranchID
			WHERE Copies <2
GO
